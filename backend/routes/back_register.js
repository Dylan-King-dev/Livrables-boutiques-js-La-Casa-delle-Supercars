...
router.post('/back_register', async (req, res) => {
  try {
    const { 
        nom, 
        prenom, 
    ...
    // Si un utilisateur avec cet email existe déjà, on retourne une erreur avec message
    ...
    // Insertion du nouvel utilisateur dans la base de données en requéte SQL (les ? signifient les valeurs à insérer)
